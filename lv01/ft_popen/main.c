...
int	main(void)
{
	...
	close(fd2);
	wait(NULL);
	// Test 3: pipe the output of "ls" to "wc -l" (not very safe, esp w/ valgrind)
	...
	if (fd2 == -1)
	    return 1;
	printf("pipe the output of 'ls' to 'wc -l'\n");
